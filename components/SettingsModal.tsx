  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200 pointer-events-auto">
      <div className={`relative w-full max-w-2xl rounded-2xl border p-1 shadow-2xl overflow-hidden ${currentThemeConfig.classes.modalBg}`}>
        ...
        {/* Header */}
        <div className={`p-4 md:p-5 flex justify-between items-center rounded-t-xl ${currentThemeConfig.classes.headerBg}`}>
          <div className="flex items-center gap-3">
            <span className="text-2xl">⚙️</span>
            <div>
              <h2 className={`text-xl md:text-2xl ${currentThemeConfig.classes.titleText}`}>
                Game Settings & Save Management
              </h2>
              <p className={`text-xs ${currentThemeConfig.classes.subText}`}>
                Manage save slots, export/import data, and customize aesthetic UI themes
              </p>
            </div>
          </div>
        ...
        <div className="p-4 md:p-6 space-y-6 max-h-[80vh] overflow-y-auto custom-scrollbar">
          ...
          <div className={`p-4 rounded-xl border ${currentThemeConfig.classes.cardBg}`}>
            <h3 className={`text-sm uppercase font-bold tracking-widest flex items-center gap-2 mb-3 ${currentThemeConfig.classes.accentText}`}>
              <span>💾</span> Save / Load / Backup Manager
            </h3>
