    ...
    return (
        <div className="flex flex-col items-center select-none">
            ...
            >
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 overflow-x-auto no-scrollbar py-0.5 px-0.5 max-w-[55vw] sm:max-w-[380px] md:max-w-xl [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
