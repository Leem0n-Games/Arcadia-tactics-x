                    ...
                    <div className="flex gap-2">
                        {isEquippedByActive ? (
                            ...
                            <button
                                ...
                                className="flex-1 min-h-[44px] py-2.5 px-4 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-serif font-black text-xs uppercase tracking-wider shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2"
                            >
                                <span>⚔️</span>
                                <span>Equipar en {activeChar.name}</span>
                            </button>
                        )}
                    </div>
                )}
                            ...
                            <div className="flex items-center gap-1.5 bg-slate-900/80 p-1 rounded-xl border border-white/10">
                                ...
                                {party.map(p => (
                                    <button
                                        ...
                                        className={`flex-1 py-1 px-1.5 rounded-lg text-[9px] font-bold truncate transition-all ${
                                            targetCharId === p.id 
