                        ...
                        {mainHandItem ? (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-rose-600 hover:bg-rose-500 text-white flex items-center justify-center text-[9px] font-bold shadow-md z-20"
                                    title="Desequipar"
                                >
                                    ✕
                                </button>
