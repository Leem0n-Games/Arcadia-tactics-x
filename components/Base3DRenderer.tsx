      ...
      <div className={containerClassName}>
        ...
        >
          <Base3DContext.Provider value={contextValue}>
            {/* Base Lighting Setup */}
            <hemisphereLight color={skyColor} groundColor={groundColor} intensity={isShadowRealm ? 0.35 : 0.65} />
            <ambientLight intensity={ambientIntensity} color={isShadowRealm ? '#3b0764' : '#fff7ed'} />
            <directionalLight
              ...
              shadow-radius={perfProfile.isMobile ? 1.0 : 2.5}
            />
