  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tab Navigation */}
        <div className={`px-4 py-2 border-b flex gap-2 text-xs font-bold ${themeConfig.classes.divider}`}>
          <button 
          ...
          >
            <span>🎲</span>
            <span>Descanso Corto (Short Rest)</span>
          </button>
          ...
          >
            <span>🏨</span>
            <span>Descanso Largo en la Posada (Long Rest)</span>
          </button>
        </div>
